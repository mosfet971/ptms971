...
const handlerYes = ()=> {
    dataMethods.newNote("0", text.value);
    text.value = "";
};
...
<template>
<BsModal id="createNoteModal0" label="Добавление заметки" type="Save" v-bind:yesHandler="handlerYes"  v-bind:noHandler="handlerNo">
