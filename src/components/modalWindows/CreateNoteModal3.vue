...
const handlerYes = ()=> {
    dataMethods.newNote("3", text.value);
    text.value = "";
};
...
<template>
<BsModal id="createNoteModal3" label="Добавление заметки" type="Save" v-bind:yesHandler="handlerYes"  v-bind:noHandler="handlerNo">
