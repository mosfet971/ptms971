...
const handlerYes = ()=> {
    dataMethods.newNote("1", text.value);
    text.value = "";
};
...
<template>
<BsModal id="createNoteModal1" label="Добавление заметки" type="Save" v-bind:yesHandler="handlerYes"  v-bind:noHandler="handlerNo">
